...
class PluginUpdate extends Command
{
    ...
    {
        $help = 'Update WordPress plugins using Composer.' . PHP_EOL .
            'The plugin you want to update must have been installed with composer.';
        $this->setDescription('Update WordPress plugins')
            ->setHelp($help)
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln([
            ...
            "<info>Running: composer update {$pluginName}</info>",
